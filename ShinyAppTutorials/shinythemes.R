...
library(shinythemes) # addin the shinythemes package
ui <- fluidPage(theme = shinytheme("darkly"), # displaying different themes, replace this line when publishing with theme = shinytheme("dark")
